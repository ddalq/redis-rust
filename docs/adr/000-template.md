...
This section tracks how this ADR evolves as we learn more and make new decisions.
Each entry should include the date, what was decided, and why.

| Date | Decision | Rationale |
|------|----------|-----------|
| YYYY-MM-DD | Initial ADR created | [Why this decision was made] |
