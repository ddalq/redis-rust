...
fn main() {
    ...
    println!(
        "Running {} iterations of each command type...\n",
        iterations
    );
    ...
    let total_time = set_duration
        ...
        + zadd_duration;
    println!(
        "Total: {} ops in {:?} ({:.0} ops/sec average)",
        total_ops,
        total_time,
